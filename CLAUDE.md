# CLAUDE.md — BLR Claude Code Workshop (Infosys)

This file provides context and guidance for Claude Code when working within this repository.

## Repository Purpose

This repo is the student workshop package for the Bengaluru Claude Code Workshop (Infosys cohort). It contains workshop materials, guides, slides, code snippets, and the hackathon brief and submissions.

## Directory Structure

```
blr-cc-workshop-infosys/
├── agenda/          # Workshop schedule files
├── faq/             # Frequently asked questions and troubleshooting
├── guides/          # Student setup and walkthrough guides
├── hackathon/       # Hackathon materials
│   ├── scenarios/   # Hackathon scenario briefs
│   │   └── README.md
...
- Caroline Matthews will push updated hackathon materials — current scenario files are placeholders.
